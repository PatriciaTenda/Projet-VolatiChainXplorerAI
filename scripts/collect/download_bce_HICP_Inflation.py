...
""" Script pour télécharger les taux d'inflation depuis le site de la Banque Centrale Européenne (BCE).
...
data_dataset_code = os.getenv("data_dataset_code_HICP")
data_serie_key = os.getenv("data_serie_key_HICP")
...
print(default_url)
# Nom du fichier csv
default_filename = "Data/raw/csvFile/bce_HICP_Inflation_download.csv"
