...
data_dataset_code = os.getenv("data_dataset_code")
data_serie_key = os.getenv("data_serie_key")
...
def download_bce_mro(url, filename):
...
if __name__ == "__main__":
    download_bce_mro(default_url, default_filename)